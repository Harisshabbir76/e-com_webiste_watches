      ...
      <Container>
        <div className="max-w-md mx-auto py-24 flex flex-col gap-10">
          <div className="flex flex-col items-center text-center gap-4">
            <span className="text-primary tracking-[0.4em] text-[10px] font-bold uppercase">Join the Collection</span>
            <h1 className="text-4xl text-white font-medium">Create Account</h1>
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <Link href="/login" className="text-primary text-[10px] uppercase font-bold tracking-widest border-b border-primary pb-1">
              Login Instead
            </Link>
          </div>
        </div>
